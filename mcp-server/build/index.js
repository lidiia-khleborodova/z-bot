...
import { buildIndex, searchArticles } from './search.js';
...
async function fetchAllArticles() {
    const articles = [];
    let nextPage = `https://${ZENDESK_SUBDOMAIN}/api/v2/help_center/articles.json?per_page=100`;
...
server.registerTool('search_help_articles', {
...
server.registerTool('generate_fashion_image', {
...
server.registerTool('search_asset_library', {
